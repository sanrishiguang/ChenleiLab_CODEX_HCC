...
path_to_data = r'E:\myPythonProject\ValidationData\20220412 AllsubtypeCN\cells_r=50_CN=40.csv'
#path_to_data = r'E:\myPythonProject\CODEX TLS 0830\TLS_seurat_python.csv'
X = 'XMin'   #对照表格修改
Y = 'YMin'    #对照表格修改
reg = 'Class'    #对照表格修改
file_type = 'csv'   #对照表格修改
cluster_col = 'Allsubtypes'      #对照表格修改
...
group = arr.groupby(["Class","Allsubtypes"]).agg('sum')
group.shape
##根据interaction count计算logs Odds ratio, 并可视化
group.to_csv(r"E:\11. CODEX\ValidationData\spatial analysis\spatialanalysis_output_subtype_5TPs_class.csv")
...
ks = [5,10,15] # k=5 means it collects 5 nearest neighbors for each center cell
path_to_data = r'E:\myPythonProject\TrainingData\AllCN_r50_CN40_0331\spatialanalysis\data_TP1.csv'
#path_to_data = r'E:\myPythonProject\CODEX TLS 0830\TLS_seurat_python.csv'
X = 'XMin'   #对照表格修改
Y = 'YMin'    #对照表格修改
reg = 'Class'    #对照表格修改
...
group.shape
##根据interaction count计算logs Odds ratio, 并可视化
group.to_csv(r"E:\11. CODEX\TrainingData\20220308\AllCN_r50_CN40_0331\spatial analysis\spatialanalysis_output_subtype_TP1_class.csv")
...
#ks = [5,10,20] # k=5 means it collects 5 nearest neighbors for each center cell
ks = [5,10,15] # k=5 means it collects 5 nearest neighbors for each center cell
path_to_data = r'E:\myPythonProject\TrainingData\AllCN_r50_CN40_0331\spatialanalysis\data_TP2.csv'
#path_to_data = r'E:\myPythonProject\CODEX TLS 0830\TLS_seurat_python.csv'
X = 'XMin'   #对照表格修改
Y = 'YMin'    #对照表格修改
reg = 'Class'    #对照表格修改
...
group.shape
##根据interaction count计算logs Odds ratio, 并可视化
group.to_csv(r"E:\11. CODEX\TrainingData\20220308\AllCN_r50_CN40_0331\spatial analysis\spatialanalysis_output_subtype_TP2_class.csv")
...
#ks = [5,10,20] # k=5 means it collects 5 nearest neighbors for each center cell
ks = [5,10,15] # k=5 means it collects 5 nearest neighbors for each center cell
path_to_data = r'E:\myPythonProject\TrainingData\AllCN_r50_CN40_0331\spatialanalysis\data_TP3.csv'
#path_to_data = r'E:\myPythonProject\CODEX TLS 0830\TLS_seurat_python.csv'
X = 'XMin'   #对照表格修改
Y = 'YMin'    #对照表格修改
reg = 'Class'    #对照表格修改
...
group.shape
##根据interaction count计算logs Odds ratio, 并可视化
group.to_csv(r"E:\11. CODEX\TrainingData\20220308\AllCN_r50_CN40_0331\spatial analysis\spatialanalysis_output_subtype_TP3_class.csv")
...
#ks = [5,10,20] # k=5 means it collects 5 nearest neighbors for each center cell
ks = [5,10,15] # k=5 means it collects 5 nearest neighbors for each center cell
path_to_data = r'E:\myPythonProject\TrainingData\AllCN_r50_CN40_0331\spatialanalysis\data_TP4.csv'
#path_to_data = r'E:\myPythonProject\CODEX TLS 0830\TLS_seurat_python.csv'
X = 'XMin'   #对照表格修改
Y = 'YMin'    #对照表格修改
reg = 'Class'    #对照表格修改
...
group.shape
##根据interaction count计算logs Odds ratio, 并可视化
group.to_csv(r"E:\11. CODEX\TrainingData\20220308\AllCN_r50_CN40_0331\spatial analysis\spatialanalysis_output_subtype_TP4_class.csv")
...
#ks = [5,10,20] # k=5 means it collects 5 nearest neighbors for each center cell
ks = [5,10,15] # k=5 means it collects 5 nearest neighbors for each center cell
path_to_data = r'E:\myPythonProject\TrainingData\AllCN_r50_CN40_0331\spatialanalysis\data_TP5.csv'
#path_to_data = r'E:\myPythonProject\CODEX TLS 0830\TLS_seurat_python.csv'
X = 'XMin'   #对照表格修改
Y = 'YMin'    #对照表格修改
reg = 'Class'    #对照表格修改
...
group.shape
##根据interaction count计算logs Odds ratio, 并可视化
group.to_csv(r"E:\11. CODEX\TrainingData\20220308\AllCN_r50_CN40_0331\spatial analysis\spatialanalysis_output_subtype_TP5_class.csv")
